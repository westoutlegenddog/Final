            ...
            Ok(info) => {
                ...
                match opstr {
                    ...
                    "set" => {
                        if state == false {
                            println!(
                                "The value of key \"{}\" is \"{}\", which already exists",
                                key, value
                            );
                        } else {
                    ...
                    "setslave" => {
                        println!(
                            "You can not set the slave, the master port is \"{}\"",
                            value
                        );
                    }
                    "setex" => {
                    ...
                    "setportfail" => {
                        println!(
                            "You are not using the proxy, the proxy port is \"{}\"",
                            value
                        );
                    }
